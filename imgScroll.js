...
class App extends Component {
    ...
    render() {
        return (
            ...
            <div className='Body'>
                <div>
                    <img src={imgArr[this.state.imgIndex]} />

                    {this.state.imgIndex !== 0 && <button onClick={this.handleNazadClick}> Nazad </button>}


                    {this.state.imgIndex !== imgArr.length - 1 && <button onClick={this.handleVperedClick}> Vpered </button>}
                </div>
